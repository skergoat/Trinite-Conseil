...
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<div id="et-info">
					<div id="et-info-phone">03 81 88 53 15 <span> ou </span> 06 09 47 95 29</div>
					<div id="et-info-openinghours">Du lundi au vendredi de 9h a 19h <span></span> le samedi de 8h30 a 13h30</div>
				</div> <!-- #et-info -->
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			<div class="container clearfix et_menu_container" id="menu-container">
			<?php
			...
			?>
				<div class="logo_container">
					...
					<a href="http://triniteconseil.fr/wordpress/">
